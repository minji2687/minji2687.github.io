...
export function NoteCard({ note }: NoteCardProps) {
  return (
    <Link
      href={note.href}
      className="group flex flex-col gap-2 rounded-xl border border-[var(--border-color)] bg-[var(--card-bg)] p-4 shadow-sm transition-all hover:border-[var(--accent)]/40 hover:shadow-md"
    >
